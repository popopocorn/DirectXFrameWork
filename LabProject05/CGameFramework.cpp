...
void CGameFramework::FrameAdvance() {
	...
	D3D12_RESOURCE_BARRIER d3ddResourceBarrier;
	::ZeroMemory(&d3ddResourceBarrier, sizeof(D3D12_RESOURCE_BARRIER));
	d3ddResourceBarrier.Type = D3D12_RESOURCE_BARRIER_TYPE_TRANSITION;
	d3ddResourceBarrier.Flags = D3D12_RESOURCE_BARRIER_FLAG_NONE;
	d3ddResourceBarrier.Transition.pResource =
		m_ppd3dSwapChainBackBuffers[m_nSwapChainBufferIndex];
	d3ddResourceBarrier.Transition.StateBefore = D3D12_RESOURCE_STATE_PRESENT;
	d3ddResourceBarrier.Transition.StateAfter = D3D12_RESOURCE_STATE_RENDER_TARGET;
	d3ddResourceBarrier.Transition.Subresource = D3D12_RESOURCE_BARRIER_ALL_SUBRESOURCES;
	m_pd3dCommandList->ResourceBarrier(1, &d3ddResourceBarrier);
	...
	//-------------
	d3ddResourceBarrier.Transition.StateBefore = D3D12_RESOURCE_STATE_RENDER_TARGET;
	d3ddResourceBarrier.Transition.StateAfter = D3D12_RESOURCE_STATE_PRESENT;
	d3ddResourceBarrier.Transition.Subresource = D3D12_RESOURCE_BARRIER_ALL_SUBRESOURCES;
	m_pd3dCommandList->ResourceBarrier(1, &d3ddResourceBarrier);
...
void CGameFramework::ChangeSwapChainState() {
	...
	m_pdxgiSwapChain->SetFullscreenState(not bFullScreenState, NULL);
